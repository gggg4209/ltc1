...
public class showgoltc1_1_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showgoltc1_1_6);
        ...
        bt_room.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(showgoltc1_1_6.this, ltc1_1_6.class);// หน้าที่กดไป
                startActivity(i);
            }
        });
        bt_landmark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(showgoltc1_1_6.this, landmark1.class);// หน้าที่กดไป
                startActivity(i);
            }
        });
