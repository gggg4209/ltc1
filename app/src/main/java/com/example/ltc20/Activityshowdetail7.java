...
public class Activityshowdetail7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activityshowdetail7);
        ...
        bt_room.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Activityshowdetail7.this, roomltc7.class);// หน้าที่กดไป
                startActivity(i);
        ...
        bt_landmark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Activityshowdetail7.this ,landmark7.class);// หน้าที่กดไป
                startActivity(i);
        ...
        bt_map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String lat = "18.574159" ;  // ละติจูดสมมุติ
                String lng = "98.998583" ;
