...
public class Activityshowdetail9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activityshowdetail9);
        ...
        bt_room.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Activityshowdetail9.this, roomltc9.class);// หน้าที่กดไป
                startActivity(i);
        ...
        bt_landmark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Activityshowdetail9.this ,landmark9.class);// หน้าที่กดไป
                startActivity(i);
        ...
        bt_map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String lat = "18.572848" ;  // ละติจูดสมมุติ
                String lng = "98.999425" ;
