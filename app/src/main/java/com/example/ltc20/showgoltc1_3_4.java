...
public class showgoltc1_3_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_showgoltc1_3_4);
        ...
        bt_room.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(showgoltc1_3_4.this, ltc1_3_4.class);// หน้าที่กดไป
                startActivity(i);
            }
        });
        bt_landmark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(showgoltc1_3_4.this, landmark1.class);// หน้าที่กดไป
                startActivity(i);
            }
        });
