...
public class Activityshowdetail20 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activityshowdetail20);
        ...
        bt_landmark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Activityshowdetail20.this ,landmark20.class);// หน้าที่กดไป
                startActivity(i);
