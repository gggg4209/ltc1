...
public class Activityshowdetail8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activityshowdetail8);
        ...
        bt_room.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Activityshowdetail8.this, roomltc8.class);// หน้าที่กดไป
                startActivity(i);
        ...
        bt_landmark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Activityshowdetail8.this ,landmark8.class);// หน้าที่กดไป
                startActivity(i);
