...
public class Activityshowdetail6 extends AppCompatActivity {
    Button bt_map, bt_landmark,bt_room ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activityshowdetail6);
        ...
        bt_room.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Activityshowdetail6.this, roomltc6.class);// หน้าที่กดไป
                startActivity(i);
        ...
        bt_landmark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Activityshowdetail6.this ,landmark6.class);// หน้าที่กดไป
                startActivity(i);
        ...
        bt_map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String lat = "18.573530" ;  // ละติจูดสมมุติ
                String lng = "98.998740" ;
