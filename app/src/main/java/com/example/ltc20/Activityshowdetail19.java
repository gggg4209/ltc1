...
public class Activityshowdetail19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activityshowdetail19);
        ...
        bt_room.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Activityshowdetail19.this ,room19.class);// หน้าที่กดไป
                startActivity(i);
        ...
        bt_landmark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Activityshowdetail19.this ,landmark19.class);// หน้าที่กดไป
                startActivity(i);
        ...
        bt_map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String lat = "18.574225" ;  // ละติจูดสมมุติ
                String lng = "98.999121" ;
