...
public class ImageAdapter1_4_3 extends PagerAdapter {
    ...
    private int[] mImageIds = new int[]{R.drawable.q1 ,R.drawable.q2 ,R.drawable.q25,R.drawable.q26 ,R.drawable.q27
            ...
            ,R.drawable.q67,R.drawable.q68,R.drawable.q70 ,R.drawable.q71};
    ImageAdapter1_4_3(Context context) { mContext = context; }
    @Override
