...
public class ImageAdapter1_4_5 extends PagerAdapter {
    ...
    private int[] mImageIds = new int[]{R.drawable.q1 ,R.drawable.q2 ,R.drawable.q25,R.drawable.q26 ,R.drawable.q27
            ...
            ,R.drawable.q60,R.drawable.q61,R.drawable.q62,R.drawable.q63 ,R.drawable.q72,R.drawable.q73,R.drawable.q75,R.drawable.q76 };
    ImageAdapter1_4_5(Context context) { mContext = context; }
    @Override
