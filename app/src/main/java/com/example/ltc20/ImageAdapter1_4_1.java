...
public class ImageAdapter1_4_1 extends PagerAdapter {
    ...
    private int[] mImageIds = new int[]{R.drawable.q1 ,R.drawable.q2 ,R.drawable.q25,R.drawable.q26 ,R.drawable.q27
            ...
            ,R.drawable.q60,R.drawable.q61,R.drawable.q62,R.drawable.q63,R.drawable.q64};
    ImageAdapter1_4_1(Context context) { mContext = context; }
    @Override
